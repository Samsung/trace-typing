...
parser.parse(["dummy","dummy",'-h']);
parser.parse(["dummy","dummy",'--help']);

////////////////////////////////////////////////////
// What follows is the body of the largest optparse example: https://github.com/jfd/optparse-js/blob/master/examples/nodejs-test.js
////////////////////////////////////////////////////
...
parser.parse(["-i","foo.txt","--include-file","asdf.txt","-p","Hello","pasta","--number","3"]); // <-- edited since process.ARGV is undefined
