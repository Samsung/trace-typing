...
(function() {
    ...
    ref = require('./rewriter_coffee-script'), Rewriter = ref.Rewriter, INVERSES = ref.INVERSES;

    ref1 = require('./helpers_coffee-script'), count = ref1.count, starts = ref1.starts, compact = ref1.compact, repeat = ref1.repeat, invertLiterate = ref1.invertLiterate, locationDataToString = ref1.locationDataToString, throwSyntaxError = ref1.throwSyntaxError;

    exports.X = Lexer = (function() {
        function Lexer() {}
